...
std::string HttpProtocol::handleGet(const std::string& path) {
...
std::string HttpProtocol::handlePost(std::istringstream& requestStream) {
    std::string line;
    std::string body;
...
std::string HttpProtocol::handleRequest(const std::string& request) {
